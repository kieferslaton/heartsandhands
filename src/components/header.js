  ...
  return(
    <>
      <div id="covid-banner" className="bg-dark py-1 mb-1 text-center">
          <Link to="/covid-19-response"><button class="btn btn-dark w-100 text-uppercase p-0">Click here to see how the food bank is responding to COVID-19.</button></Link>
      </div>
